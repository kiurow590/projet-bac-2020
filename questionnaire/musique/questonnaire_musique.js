...
function preload() {
    ...
    loadJSON("questionnaire/musique/musique_questionnaire.json", function(tempList) {
    ...
    // musique de fond
    musique = loadSound("questionnaire/musique/SmallRadio - LSF 7th Gear Remix.mp3");
    // police d'ecriture
    font = loadFont('questionnaire/musique/PrStart.ttf');
    // image fond
