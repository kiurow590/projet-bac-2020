...
function preload() {
    ...
    loadJSON("questionnaire/science_fiction/science_fiction_question.json", function(tempList) {
    ...
    // musique de fond
    musique = loadSound("questionnaire/science_fiction/SmallRadio - LSF 7th Gear Remix.mp3");
    // police d'ecriture
    font = loadFont('questionnaire/science_fiction/PrStart.ttf');
